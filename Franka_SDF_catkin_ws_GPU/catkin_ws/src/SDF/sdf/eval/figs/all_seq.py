...
from sdf.eval import plot_utils
...
def plot_sdf(
    seqs, ours_root, label="sdf", color="C0",
...
def main(
    ...
    do_plots(
        plot_sdf,
        incSDF_root + "/res/sdf/sdf_supervision/ray/",
        "sdf + Ray", color="C3")
    do_plots(
        plot_sdf,
        incSDF_root + "/res/sdf/sdf_supervision/normal/",
        "sdf + Normal", color="C4")
    do_plots(
        plot_sdf,
        incSDF_root + "/res/sdf/sdf_supervision/pc/",
        "sdf + Batch distance", color="C0")
    """
    ...
    # do_plots(
    #     plot_sdf,
    #     incSDF_root + "/res/sdf/frac_time_perception/0.5/",
    #     "sdf", color="C0")
    # do_plots(
    #     plot_voxblox,
    ...
    do_plots(
        plot_sdf, sdf_dir, axes, "sdf + Batch distance", color="C0")
...
if __name__ == "__main__":
    ...
    sdf_dir = incSDF_root + "/results/sdf/exp0/"
