...
"""
If slices are saved for sdf, this script generates slices
...
from sdf.eval import metrics, eval_pts, plot_utils
from sdf.geometry import frustum, transform
...
ours_root = incSDF_root + "res/sdf/slices/"
