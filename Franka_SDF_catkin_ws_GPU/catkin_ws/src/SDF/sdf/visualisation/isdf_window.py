...
class sdfWindow:
    ...
    def __init__(self, trainer, optim_iter, font_id):
        ...
        self.window = gui.Application.instance.create_window('sdf viewer', 1480, 900)
        ...
        self.panel.add_child(gui.Label('sdf controls'))
